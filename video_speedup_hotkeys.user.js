...
// @match       https://4spromax.tld/*
// @match       https://9anime.tld/*
// @match       https://a9bfed0818.tld/*
// @match       https://aether.tld/*
// @match       https://allanime.day/*
// @match       https://anihdplay.com/*
// @match       https://animixplay.to/player.html
// @match       https://anix.sh/*
// @match       https://cineby.tld/*
...
// @match       https://goload.tld/*
// @match       https://goone.tld/*
// @match       https://kerapoxy.tld/*
// @match       https://krussdomi.com/*
// @match       https://kwik.si/*
// @match       https://omegadthree.com/*
// @match       https://player.mangafrenzy.tld/*
// @match       https://mcloud.tld/*
// @match       https://mega.nz/embed/*
// @match       https://megaplay.buzz/stream/*
// @match       https://megacloud.tld/*
// @match       https://megaf.cc/*
// @match       https://megaup.tld/*
// @match       https://mp4.sh/*
// @match       https://peertube.nodja.com/*
// @match       https://player.vimeo.com/video/*
// @match       https://plyr.in/*
// @match       https://plyr.link/*
// @match       https://popcornmovies.tld/*
// @match       https://rabbitstream.net/*
// @match       https://s3taku.tld/*
